...
namespace Flynt\Components\SpecialsPackagesSlider;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=SpecialsPackagesSlider', function ($data) {
